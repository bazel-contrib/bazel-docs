...
6.  [Generate the Xcode project with rules_xcodeproj](#generate-the-xcode-project-with-rules-xcodeproj)
...
*   [`ios_unit_test`](https://github.com/bazelbuild/rules_apple/blob/master/doc/rules-ios.md#ios_unit_test)
    ...
    [generate an Xcode project with rules_xcodeproj](#generate-the-xcode-project-with-rules-xcodeproj)
...
*   [`ios_ui_test`](https://github.com/bazelbuild/rules_apple/blob/master/doc/rules-ios.md#ios_ui_test)
    ...
    using Xcode. You must [generate an Xcode project with rules_xcodeproj](#generate-the-xcode-project-with-rules-xcodeproj)
