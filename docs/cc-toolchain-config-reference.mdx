...
<table>
  ...
  <tr>
   ...
   <td>Feature-level. The feature is supported only if the specified required</td>
  ...
  <tr>
   <td><pre>implies = ['feature']```</p>
   </td>
   <td><p>Feature-level. This feature implies the specified feature(s).</p>
       Enabling a feature also implicitly enables all features implied by it
       (that is, it functions recursively).</p>
       <p>Also provides the ability to factor common subsets of functionality out of</p>
       a set of features, such as the common parts of sanitizers. Implied
       features cannot be disabled.</p>
   </td>
  </tr>
  <tr>
   <td><pre>provides = ['feature']```</p>
   </td>
   <td><p>Feature-level. Indicates that this feature is one of several mutually</p>
       exclusive alternate features. For example, all of the sanitizers could
       specify <code>provides = ["sanitizer"]</code>.</p>
       <p>This improves error handling by listing the alternatives if the user asks</p>
  ...
  with_feature_set(
   ...
   <td>Flag set-level. A feature can specify multiple flag sets with multiple.</td>
...
<table>
  ...
  <tr>
   ...
   <td>Run the compiler's parser on a header file to ensure that the header is</td>
...
<table>
  ...
  <tr>
   <td><code>action_name</code>
    ...
    <td>The Bazel action to which this action corresponds.</td>
  ...
  <tr>
   ...
   <td>The executable to invoke. The tool applied to the action will be the</td>
  ...
  <tr>
   ...
   <td>A list of flags that applies to a group of actions. Same as for a</td>
       feature.
   </td>
  </tr>
  <tr>
   ...
   <td>A list of environment constraints that applies to a group of actions.</td>
...
<table>
  ...
  <tr>
   ...
   <td>A list of feature sets out of which at least one must be satisfied</td>
...
expands to `-I<path>` for each path element in the `include_paths` list. All</p>
...
expands to `-I <path>` for each path element in the `include_paths` list.</p>
...
<table>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Emitted assembly file. Applies only when the</td>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Preprocessed output. Applies only to compile</td>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Sequence of files the compiler must</td>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Sequence directories in which the compiler</td>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Sequence of flags from legacy</td>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Sequence of flags from either the</td>
  ...
  <tr>
   ...
   <td>compile</td>
   <td>Sequence of flags from the</td>
  ...
  <tr>
   ...
   <td>link</td>
   <td>Entries in the linker runtime search path (usually</td>
  ...
  <tr>
   ...
   <td>link</td>
   <td>Entries in the linker search path (usually set with</td>
  ...
  <tr>
   ...
   <td>link</td>
   <td>Location of linker param file created by bazel to</td>
  ...
  <tr>
   ...
   <td>link</td>
   <td>Presence of this variable indicates that PIC/PIE code should</td>
  ...
  <tr>
   ...
   <td>link</td>
   <td>Presence of this variable indicates that the debug</td>
  ...
  <tr>
   ...
   <td>compile, link</td>
   <td>Presence of this variable indicates that fission (per-object debug info)</td>
  ...
  <tr>
   ...
   <td>compile, link</td>
   <td> Path to the directory that stores context sensitive FDO</td>
...
<table>
  ...
  <tr>
   ...
   <td>If enabled, C++ rules will know the toolchain can produce shared</td>
     libraries.
   </td>
  </tr>
  <tr>
   ...
   <td>If enabled, Bazel will link the C++ runtime statically in static linking</td>
  ...
  <tr>
   ...
   <td>If enabled, toolchain will know to use PIC objects for dynamic libraries.</td>
