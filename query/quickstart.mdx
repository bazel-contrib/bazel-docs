...
<div>
  <devsite-expandable>
  <h4 class="showalways">Answer</h4>
  <p>This review was describing the Pizza and Amir was the reviewer. If you look at what dependencies that this rule had using</p>
  <code>bazel query --noimplicit_deps 'deps(//src/main/java/com/example/reviews:review)'</code>
