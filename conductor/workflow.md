...
8. **Commit Code Changes and Task Summary:**
   ...
   - Perform the commit. Use a concise subject line (e.g., `feat(ui): Create basic HTML structure for calculator`) and the detailed summary as the commit body.
...
6. **Create Checkpoint Commit and Attach Auditable Verification Report:**

    -   **Step 6.1: Draft Report Content:** Create a detailed verification report including the automated test command, the manual verification steps, and the user's confirmation.

    -   **Step 6.2: Perform Commit:** Stage all changes. If no changes occurred in this step, proceed with an empty commit. Perform the commit with a clear and concise message (e.g., `conductor(checkpoint): Checkpoint end of Phase X`) and use the verification report as the commit body.
