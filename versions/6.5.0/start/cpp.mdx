...
*   The <code>[`WORKSPACE` file](https://bazel.build/reference/glossary#workspace-file)</code>
...
*   One or more <code>[`BUILD` files](https://bazel.build/reference/glossary#build-file)</code>
