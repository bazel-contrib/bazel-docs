...
<table>
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--config">--config</a>` {#flag-config}
    </td>
    <td>
...
be selected with <code>--config=<strong>&lt;group&gt;</strong></code>.
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--keep_going">--keep_going</a>` {#flag-keep-going}
    </td>
    <td>
...
By default, Bazel fails eagerly.
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--remote_download_outputs">--remote_download_outputs</a>` {#flag-remote-download-outputs}
    </td>
    <td>
...
and intermediate artifacts that are necessary for local actions.
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--stamp">--stamp</a>` {#flag-stamp}
    </td>
    <td>
...
<table>
  ...
  <tr>
    <td>
       ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--announce_rc">--announce_rc</a>` {#flag-announce-rc}
    </td>
    <td>
...
machine-defined, or project-defined <strong>.bazelrc</strong> files.
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--auto_output_filter">--auto_output_filter</a>` {#flag-auto-output-filter}
    </td>
    <td>
...
<code>--auto_output_filter=<strong>none</strong></code>.
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--sandbox_debug">--sandbox_debug</a>` {#flag-sandbox-debug}
    </td>
    <td>
...
<a href="https://bazel.build/versions/8.5.1/docs/sandboxing">sandboxing documentation</a>.
...
If you think the error might be caused by sandboxing,
  ...
  <tr>
    <td>
      ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--subcommands">--subcommands (-s)</a>` {#flag-subcommands}
    </td>
    <td>
...
<table>
  ...
  <tr>
    <td>
       ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--bazelrc">--bazelrc</a>` {#flag-bazelrc}
    </td>
    <td>
...
<code>--bazelrc=<strong>dev/null</strong></code> disables the
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/docs/user-manual#host-jvm-args">--host_jvm_args</a>` {#flag-host-jvm-args}
    </td>
    <td>
...
<ul>
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--output_base">--output_base</a>` {#flag-output-base}
    </td>
    <td>
...
see <a href="https://bazel.build/versions/8.5.1/run/scripts#output-base-option">Choosing the output base</a>.
</Tip>
...
<table>
  ...
  <tr>
    <td>
       ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--java_debug">--java_debug</a>` {#flag-java-debug}
    </td>
    <td>
...
Causes Java tests to wait for a debugger connection before being executed.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--runs_per_test">--runs_per_test</a>` {#flag-runs-per-test}
    </td>
    <td>
...
flaky tests and see whether a fix causes a test to pass consistently.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--test_output">--test_output</a>` {#flag-test-output}
    </td>
    <td>
...
<table>
  ...
  <tr>
    <td>
        ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--run_under">--run_under</a>` {#flag-run-under}
    </td>
    <td>
...
<table>
  ...
  <tr>
    <td>
       ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--disk_cache">--disk_cache</a>` {#flag-disk-cache}
    </td>
    <td>
...
<code>--disk_cache=<strong>&lt;path&gt;</strong></code> to your command.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--jobs">--jobs</a>` {#flag-jobs}
    </td>
    <td>
...
cluster executes more jobs than you have cores locally.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--local_resources">--local_resources</a>` {#flag-local-resources}
    </td>
    <td>
...
This has no impact on the amount of CPU or RAM that the Bazel
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--sandbox_base">--sandbox_base</a>` {#flag-sandbox-base}
    </td>
    <td>
...
<table>
  ...
  <tr>
    <td>
       ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--flaky_test_attempts">--flaky_test_attempts</a>` {#flag-flaky-test-attempts}
    </td>
    <td>
...
the test summary.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--remote_cache">--remote_cache</a>` {#flag-remote-cache}
    </td>
    <td>
...
speed up Bazel builds. It can be combined with a local disk cache.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--remote_download_regex">--remote_download_regex</a>` {#flag-remote-download-regex}
    </td>
    <td>
...
patterns may be specified by repeating this flag.
  ...
  <tr>
    <td>
     ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--remote_executor">--remote_executor</a>` {#flag-remote-executor}
    </td>
    <td>
...
<code>--remote_instance_name=<strong>&lt;name&gt;</strong></code>.
  ...
  <tr>
    <td>
     ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--remote_instance_name">--remote_instance_name</a>` {#flag-remote-instance-name}
    </td>
    <td>
...
The value to pass as <code>instance_name</code> in the remote execution API.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/docs/user-manual#show-timestamps">--show-timestamps</a>` {#flag-show-timestamps}
    </td>
    <td>
...
quickly understand what step took how long.
  ...
  <tr>
    <td>
    ### `<a href="https://bazel.build/versions/8.5.1/reference/command-line-reference#flag--spawn_strategy">--spawn_strategy</a>` {#flag-spawn-strategy}
    </td>
    <td>
