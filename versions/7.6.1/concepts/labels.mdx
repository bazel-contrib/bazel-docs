...
name](/versions/7.6.1/external/overview#canonical-repo-name), which is unique within
...
labels with an [*apparent* repo name](/versions/7.6.1/external/overview#apparent-repo-name),
which looks like:
...
[target patterns](/versions/7.6.1/run/build#specifying-build-targets).
...
[Bazel Query Language](/versions/7.6.1/query/language).
...
outputs as described in the [Build Encyclopedia](/versions/7.6.1/reference/be/overview).
...
the rule's kind; see the [Build Encyclopedia](/versions/7.6.1/reference/be/overview) for a
...
[General Rules: genrule](/versions/7.6.1/reference/be/general#genrule).
