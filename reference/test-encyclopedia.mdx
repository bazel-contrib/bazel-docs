...
| `TEST_SIZE`                               | The test [`size`](#size)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | optional    |
| `TEST_TIMEOUT`                            | The test [`timeout`](#timeout) in seconds                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | optional    |
| `TEST_SHARD_INDEX`                        | shard index, if [`sharding`](#test-sharding) is used                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | optional    |
| `TEST_SHARD_STATUS_FILE`                  | path to file to touch to indicate support for [`sharding`](#test-sharding)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | optional    |
| `TEST_SRCDIR`                             | absolute path to the base of the runfiles tree                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | required    |
| `TEST_TOTAL_SHARDS`                       | total [`shard count`](/reference/be/common-definitions#test.shard_count), if [`sharding`](#test-sharding) is used                                                                                                                                                                                                                                                                                                                                                                                                                                                     | optional    |
...
| `TESTBRIDGE_TEST_ONLY`                    | value of [`--test_filter`](/docs/user-manual#flag--test_filter), if specified                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | optional    |
| `TZ`                                      | `UTC`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | required    |
