...
<table>
  ...
  <tr>
    ...
    <td>absolute path to a private file in a writable directory (This file</td>
  ...
  <tr>
    ...
    <td>absolute path to a private file in a writable directory (used to write</td>
      Logsplitter protobuffer log)</td>
    <td>optional</td>
  </tr>
  <tr>
    <td><code>TEST_PREMATURE_EXIT_FILE</code></td>
    <td>absolute path to a private file in a writable directory (used for</td>
  ...
  <tr>
    ...
    <td>absolute path to a private writable directory (used to write undeclared</td>
...
<table>
  ...
  <tr>
    ...
    <tr>
      ...
      <td>don't include test target in wildcard target patterns like</td>
