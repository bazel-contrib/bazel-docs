...
- `BINDIR`: The base of the generated binary tree for the target
  ...
  recommended way to get its path is `$(`[`execpath`](#predefined_label_variables)` toolname)`,
  where *toolname* must be listed in the `genrule`'s
  [`tools`](/reference/be/general.html#genrule.tools) attribute.
...
[`cmd`](/reference/be/general.html#genrule.cmd) attribute and are
...
- `OUTS`: The `genrule`'s [`outs`](/reference/be/general.html#genrule.outs) list. If you have
  only one output file, you can also use `$@`.

- `SRCS`: The `genrule`'s [`srcs`](/reference/be/general.html#genrule.srcs) list (or more
  precisely: the path names of the files corresponding to labels in the
  [`srcs`](/reference/be/general.html#genrule.srcs) list).
...
- `execpath`: Denotes the path beneath the
  ...
  `show_app_output`'s [`tools`](/reference/be/general.html#genrule.tools) attribute.
...
- `rootpath`: Denotes the path that a built binary can use to
  ...
  **Note:** This only works if
  [`--enable_runfiles`](/reference/command-line-reference#flag--enable_runfiles) is enabled, which is not the case on
...
also reference labels in [`data`](/reference/be/c-cpp.html#cc_binary.data).
...
Some rules, like [`java_binary`](/reference/be/java.html#java_binary), implicitly
...
- `JAVA`: The "java" command (a Java virtual
  machine). Avoid this, and use a [`java_binary`](/reference/be/java.html#java_binary) rule
