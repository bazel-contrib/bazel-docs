...
- [constraint\_setting](#constraint-setting)
- [constraint\_value](#constraint-value)
- [platform](#platform)
- [toolchain](#toolchain)
- [toolchain\_type](#toolchain-type)
...
List of [labels](/concepts/labels); [nonconfigurable](common-definitions.html#configurable-attributes); default is `[]`
 ...
 See the section on [Platform Inheritance](#platform-inheritance) for details.
...
String; [nonconfigurable](common-definitions.html#configurable-attributes); default is `""`
 ...
 [Platform Inheritance](#platform-inheritance) for details.
