...
### Arguments {#constraint_setting_args}
...
For more details, see the
[Platforms](https://bazel.build/docs/platforms) page.
#### Example {#constraint_value_examples}
...
### Arguments {#constraint_value_args}
...
#### Example {#platform_flags_examples}
...
### Platform Inheritance {#platform_inheritance}
...
#### Example: Constraint Values {#platform_inheritance_examples}
...
#### Example: Execution properties {#platform_inheritance_exec_examples}
...
#### Example {#toolchain_type_examples}
