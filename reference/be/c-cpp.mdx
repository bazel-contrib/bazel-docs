...
- [cc\_binary](#cc-binary)
- [cc\_import](#cc-import)
- [cc\_library](#cc-library)
- [cc\_shared\_library](#cc-shared-library)
- [cc\_static\_library](#cc-static-library)
- [cc\_test](#cc-test)
- [cc\_toolchain](#cc-toolchain)
- [fdo\_prefetch\_hints](#fdo-prefetch-hints)
- [fdo\_profile](#fdo-profile)
- [memprof\_profile](#memprof-profile)
- [propeller\_optimize](#propeller-optimize)
...
[`local_defines`](#cc-binary.local-defines) instead.
 `distribs`
...
Unlike [COPTS](#cc-binary.copts), these flags are added for this rule
and every rule that depends on it. (Note: not the rules it depends upon!) Be
very careful, since this may have far-reaching effects. When in doubt, add
"-I" flags to [COPTS](#cc-binary.copts) instead.
...
[cc\_binary](#cc-binary) rule are only loaded manually by other programs, so
it should not be considered a substitute for the [cc\_library](#cc-library)
...
(including values explicitly specified in the rule's [copts](#cc-binary.copts) attribute)
