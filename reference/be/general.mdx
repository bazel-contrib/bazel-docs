...
#### Examples {#config_setting_examples}
...
#### Implicit output targets {#starlark_doc_extract_implicit_outputs}
...
### Arguments {#starlark_doc_extract_args}
