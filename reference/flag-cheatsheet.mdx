...
### [`--config`](https://bazel.build/reference/command-line-reference#flag--config) {#flag-config}
...
### [`--keep_going`](https://bazel.build/reference/command-line-reference#flag--keep_going) {#flag-keep-going}

Bazel should try as much as possible to continue with build and test execution. By default, Bazel fails eagerly.

### [`--remote_download_outputs`](https://bazel.build/reference/command-line-reference#flag--remote_download_outputs) {#flag-remote-download-outputs}
...
### [`--stamp`](https://bazel.build/reference/command-line-reference#flag--stamp) {#flag-stamp}
...
### [`--announce_rc`](https://bazel.build/reference/command-line-reference#flag--announce_rc) {#flag-announce-rc}

Shows which flags are implicitly set through user-defined, machine-defined, or project-defined `.bazelrc` files.

### [`--auto_output_filter`](https://bazel.build/reference/command-line-reference#flag--auto_output_filter) {#flag-auto-output-filter}
...
### [`--sandbox_debug`](https://bazel.build/reference/command-line-reference#flag--sandbox_debug) {#flag-sandbox-debug}
...
### [`--subcommands (-s)`](https://bazel.build/reference/command-line-reference#flag--subcommands) {#flag-subcommands}
...
### [`--bazelrc`](https://bazel.build/reference/command-line-reference#flag--bazelrc) {#flag-bazelrc}
...
### [`--host_jvm_args`](https://bazel.build/docs/user-manual#host-jvm-args) {#flag-host-jvm-args}
...
### [`--output_base`](https://bazel.build/reference/command-line-reference#flag--output_base) {#flag-output-base}
...
### [`--java_debug`](https://bazel.build/reference/command-line-reference#flag--java_debug) {#flag-java-debug}

Causes Java tests to wait for a debugger connection before being executed.

### [`--runs_per_test`](https://bazel.build/reference/command-line-reference#flag--runs_per_test) {#flag-runs-per-test}
...
### [`--test_filter`](https://bazel.build/reference/command-line-reference#flag--test_filter) {#flag-test-filter}
...
### [`--test_output`](https://bazel.build/reference/command-line-reference#flag--test_output) {#flag-test-output}
...
### [`--run_under`](https://bazel.build/reference/command-line-reference#flag--run_under) {#flag-run-under}
...
### [`--disk_cache`](https://bazel.build/reference/command-line-reference#flag--disk_cache) {#flag-disk-cache}
...
### [`--jobs`](https://bazel.build/reference/command-line-reference#flag--jobs) {#flag-jobs}
...
### [`--local_resources`](https://bazel.build/reference/command-line-reference#flag--local_resources) {#flag-local-resources}
...
### [`--sandbox_base`](https://bazel.build/reference/command-line-reference#flag--sandbox_base) {#flag-sandbox-base}
...
### [`--flaky_test_attempts`](https://bazel.build/reference/command-line-reference#flag--flaky_test_attempts) {#flag-flaky-test-attempts}
...
### [`--remote_cache`](https://bazel.build/reference/command-line-reference#flag--remote_cache) {#flag-remote-cache}
...
### [`--remote_download_regex`](https://bazel.build/reference/command-line-reference#flag--remote_download_regex) {#flag-remote-download-regex}
...
### [`--remote_executor`](https://bazel.build/reference/command-line-reference#flag--remote_executor) {#flag-remote-executor}
...
### [`--remote_instance_name`](https://bazel.build/reference/command-line-reference#flag--remote_instance_name) {#flag-remote-instance-name}

The value to pass as `instance_name` in the remote execution API.

### [`--show_timestamps`](https://bazel.build/docs/user-manual#show-timestamps) {#flag-show-timestamps}
...
### [`--spawn_strategy`](https://bazel.build/reference/command-line-reference#flag--spawn_strategy) {#flag-spawn-strategy}
