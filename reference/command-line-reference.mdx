...
<ParamField path="--[no]terminal_hyperlinks" type="boolean" default="auto">
  If true (or auto with color enabled), format terminal file paths, test logs, and build results URLs as clickable OSC 8 hyperlinks.
...
<ParamField path="--experimental_disk_cache_gc_idle_delay" type="An immutable length of time." default="5m">
...
<ParamField path="--experimental_disk_cache_gc_max_age" type="An immutable length of time." default="0">
...
<ParamField path="--experimental_disk_cache_gc_max_size" type="a size in bytes, optionally followed by a K, M, G or T multiplier" default="0">
...
<ParamField path="--persistent_android_dex_desugar" type="void">
...
<ParamField path="--persistent_android_resource_processor" type="void">
...
<ParamField path="--persistent_multiplex_android_dex_desugar" type="void">
...
<ParamField path="--persistent_multiplex_android_resource_processor" type="void">
...
<ParamField path="--persistent_multiplex_android_tools" type="void">
