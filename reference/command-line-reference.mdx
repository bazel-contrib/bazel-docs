...
If true, disallow sdk\_frameworks and weak\_sdk\_frameworks attributes in objc\_library and objc\_import.
...
specified via `<param_name>=<param_value>`, for example `my_param=my_val` where</p>
