...
- [difference\_update](#difference-update)
- [discard](#discard)
- [intersection](#intersection)
- [intersection\_update](#intersection-update)
...
- [symmetric\_difference\_update](#symmetric-difference-update)
- [union](#union)
- [update](#update)
...
set, see [`difference_update`](#difference-update) or the `-=`
...
[`difference_update`](#difference-update) or the `-=` augmented
