...
| --- | --- |
| `x` | [string](../core/string.mdx); required  JSON string to decode. |
...
| --- | --- |
| `x` | required |
| `prefix` | [string](../core/string.mdx); default is `''` |
| `indent` | [string](../core/string.mdx); default is `'\t'` |
...
| Parameter | Description |
| --- | --- |
| `s` | [string](../core/string.mdx); required |
| `prefix` | [string](../core/string.mdx); default is `''` |
| `indent` | [string](../core/string.mdx); default is `'\t'` |