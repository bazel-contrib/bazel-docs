...
| --- | --- |
| `target_label` | [Label](../builtins/Label.mdx); required  The label for the \*\_binary target |
| `stripped_file` | [File](../builtins/File.mdx); or `None`; default is `None`  The stripped file (the explicit ".stripped" target) |
| `unstripped_file` | [File](../builtins/File.mdx); required  The unstripped file (the default executable target). |
| `dwp_file` | [File](../builtins/File.mdx); or `None`; default is `None`  The .dwp file (for fission builds) or null if --fission=no. |
