...
A provider for the binary file and its associated .dwp files, if fission is enabled.If Fission ([Debug Fission](https://gcc.gnu.org/wiki/DebugFission)) is not enabled, the dwp file will be null.
