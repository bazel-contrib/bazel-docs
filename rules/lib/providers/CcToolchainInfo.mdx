...
- [all\_files](#all-files)
- [ar\_executable](#ar-executable)
- [built\_in\_include\_directories](#built-in-include-directories)
- [compiler](#compiler)
- [compiler\_executable](#compiler-executable)
- [cpu](#cpu)
- [dynamic\_runtime\_lib](#dynamic-runtime-lib)
- [gcov\_executable](#gcov-executable)
- [ld\_executable](#ld-executable)
- [libc](#libc)
- [needs\_pic\_for\_dynamic\_libraries](#needs-pic-for-dynamic-libraries)
- [nm\_executable](#nm-executable)
- [objcopy\_executable](#objcopy-executable)
- [objdump\_executable](#objdump-executable)
- [preprocessor\_executable](#preprocessor-executable)
- [static\_runtime\_lib](#static-runtime-lib)
- [strip\_executable](#strip-executable)
- [sysroot](#sysroot)
- [target\_gnu\_system\_name](#target-gnu-system-name)
