---
title: 'CcToolchainInfo {#modules.CcToolchainInfo}'
---
...
```
None CcToolchainInfo.disallowed_copts_infos
```

Returns the list of disallowed_copts_info structs for disallowed copts enforcement.
## dynamic_runtime_lib {#dynamic_runtime_lib}
