...
- [direct\_module\_maps](#direct-module-maps)
- [direct\_sources](#direct-sources)
- [j2objc\_library](#j2objc-library)
- [module\_map](#module-map)
- [source](#source)
- [strict\_include](#strict-include)
- [umbrella\_header](#umbrella-header)
