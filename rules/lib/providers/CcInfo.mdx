...
| --- | --- |
| `compilation_context` | [CompilationContext](../builtins/CompilationContext.mdx); or `None`; default is `None`  The `CompilationContext`. |
| `linking_context` | [struct](../builtins/struct.mdx); or `None`; default is `None`  The `LinkingContext`. |
| `debug_context` | [struct](../builtins/struct.mdx); or `None`; default is `None`  The `DebugContext`. |
