...
[`depset`](../builtins/depset.mdx) of [`File`](../builtins/File.mdx) objects representing instrumented source files for this target and its dependencies.
