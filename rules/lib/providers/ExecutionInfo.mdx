...
| --- | --- |
| `requirements` | [dict](../core/dict.mdx); default is `\{\}`  A dict indicating special execution requirements, such as hardware platforms. |
| `exec_group` | [string](../core/string.mdx); default is `'test'`  The name of the exec group that is used to execute the test. |
