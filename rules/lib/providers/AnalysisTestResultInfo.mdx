...
| --- | --- |
| `success` | [bool](../core/bool.mdx); required  If true, then the analysis-phase test represented by this target should pass. If false, the test should fail. |
| `message` | [string](../core/string.mdx); required  A descriptive message containing information about the test and its success/failure. |
