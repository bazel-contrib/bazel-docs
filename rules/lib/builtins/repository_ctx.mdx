...
```
string repository_ctx.integrity_hash(algorithm='', path='', *, watch='auto')
```

Calculates the subresource integrity hash for the given file.

### Parameters

| Parameter | Description |
| --- | --- |
| `algorithm` | [string](../core/string); default is `''`  The hash algorithm to use. Supported algorithms are: 'sha256', 'sha384', 'sha512' |
| `path` | [string](../core/string); or [Label](../builtins/Label); or [path](../builtins/path); default is `''`  Path of the file to calculate a subresource integrity hash. |
