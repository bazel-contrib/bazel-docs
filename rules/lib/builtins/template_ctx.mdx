...
ParameterDescription`subdirectory`[string](../core/string.html);
 required

 The relative path of the subdirectory within the directory.
 `directory`[File](../builtins/File.html);
 required

 The directory in which the subdirectory should be created.
