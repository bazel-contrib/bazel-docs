...
- [class\_jar](#class-jar)
- [enabled](#enabled)
- [processor\_classnames](#processor-classnames)
- [processor\_classpath](#processor-classpath)
- [source\_jar](#source-jar)
- [transitive\_class\_jars](#transitive-class-jars)
- [transitive\_source\_jars](#transitive-source-jars)
