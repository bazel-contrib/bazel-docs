...
- [empty\_filenames](#empty-filenames)
- [files](#files)
- [merge](#merge)
- [merge\_all](#merge-all)
- [root\_symlinks](#root-symlinks)
- [symlinks](#symlinks)
...
_Note:_ When you have many runfiles objects to merge, use [`merge_all()`](#merge-all) rather than calling `merge` in a loop. This avoids constructing deep depset structures which can cause build failures.
