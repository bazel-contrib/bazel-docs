...
A container of information regarding a set of files required at runtime by an executable. This object should be passed via [`DefaultInfo`](../providers/DefaultInfo.mdx) in order to tell the build system about the runfiles needed by the outputs produced by the rule.
...
| --- | --- |
| `other` | [runfiles](../builtins/runfiles.mdx); required  The runfiles object to merge into this. |
...
| Parameter | Description |
| --- | --- |
| `other` | [sequence](../core/list.mdx) of [runfiles](../builtins/runfiles.mdx)s; required  The sequence of runfiles objects to merge into this. |
