...
More commonly, however, the [apple](../fragments/apple.mdx) configuration fragment has fields/methods that allow rules to determine the platform for which a target is being built.
