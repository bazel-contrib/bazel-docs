...
- [dirname](#dirname)
- [extension](#extension)
- [is\_directory](#is-directory)
- [is\_source](#is-source)
- [is\_symlink](#is-symlink)
- [owner](#owner)
- [path](#path)
- [root](#root)
- [short\_path](#short-path)
- [tree\_relative\_path](#tree-relative-path)
