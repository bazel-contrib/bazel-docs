...
- [bytecode\_optimization\_pass\_actions](#bytecode-optimization-pass-actions)
- [bytecode\_optimizer\_mnemonic](#bytecode-optimizer-mnemonic)
- [default\_javac\_flags](#default-javac-flags)
- [default\_javac\_flags\_depset](#default-javac-flags-depset)
- [default\_jvm\_opts](#default-jvm-opts)
- [disallow\_java\_import\_exports](#disallow-java-import-exports)
- [multi\_release\_deploy\_jars](#multi-release-deploy-jars)
- [one\_version\_enforcement\_level](#one-version-enforcement-level)
- [plugins](#plugins)
- [run\_android\_lint](#run-android-lint)
- [split\_bytecode\_optimization\_pass](#split-bytecode-optimization-pass)
- [strict\_java\_deps](#strict-java-deps)
- [use\_header\_compilation\_direct\_deps](#use-header-compilation-direct-deps)
- [use\_ijars](#use-ijars)
