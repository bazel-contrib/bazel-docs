...
<ul>
    ...
    <a href="#alwayslink_by_default">alwayslink_by_default</a>
      ...
      <li>
    <a href="#builtin_objc_strip_action">builtin_objc_strip_action</a>
  </li>
      <li>
    ...
    Returns whether objc_library and objc_import should default to alwayslink=True.
        ...
        <h2 id="builtin_objc_strip_action">builtin_objc_strip_action</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../core/bool.html">bool</a> objc.builtin_objc_strip_action</pre></p>
