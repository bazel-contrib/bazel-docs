...
<ul>
    ...
    <a href="#instrumented_files_info">instrumented_files_info</a>
      ...
      <h2 id="instrumented_files_info">instrumented_files_info</h2>
        <p><pre class="rule-signature"><a class="anchor" href="../providers/InstrumentedFilesInfo.html">InstrumentedFilesInfo</a> coverage_common.instrumented_files_info(ctx, *, source_attributes=[], dependency_attributes=[], extensions=None, metadata_files=[], baseline_coverage_files=None)</pre></p>
      ...
      <table class="table table-bordered table-condensed table-params">
        ...
        <tbody>
            ...
            <td>
                  ...
                  <tr>
            <td id="instrumented_files_info.baseline_coverage_files">
              <code>baseline_coverage_files</code>
            </td>
            <td>
                          <a class="anchor" href="../core/list.html">sequence</a> of <a class="anchor" href="../builtins/File.html">File</a>s; or <code>None</code>;
                                     default is <code>None</code><br/>
