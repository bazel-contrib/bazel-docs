...
- [apple\_host\_system\_env](#apple-host-system-env)
- [apple\_toolchain](#apple-toolchain)
- [dotted\_version](#dotted-version)
- [platform](#platform)
- [platform\_type](#platform-type)
- [target\_apple\_env](#target-apple-env)
