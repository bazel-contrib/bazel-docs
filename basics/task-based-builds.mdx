...
Take this example from the [Ant manual](https://ant.apache.org/manual/using.html):
...
1. Loads a file named `build.xml` in the current directory and parses it to create the graph structure shown in Figure 1.
