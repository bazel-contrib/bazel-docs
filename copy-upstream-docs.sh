...
BROKEN_FILES="
    concepts/build-files.md
    concepts/dependencies.md
    concepts/labels.md
    configure/windows.md
    contribute/search.md
    docs/cc-toolchain-config-reference.md
    docs/user-manual.md
    query/quickstart.md
    reference/flag-cheatsheet.md
    reference/test-encyclopedia.md
    run/build.md
"
