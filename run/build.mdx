...
<tr>
  <td><code>//...</code></td>
  <td>All rule targets in packages in the main repository. Does not include targets</td>
  from <a href="/docs/external">external repositories</a>.</td>
</tr>
<tr>
  <td><code>//:all</code></td>
  <td>All rule targets in the top-level package, if there is a `BUILD` file at the</td>
