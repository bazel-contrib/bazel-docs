...
*   `@<repo_name>`: The repo with the given [apparent
    name](/external/overview#apparent-repo-name) in the context of the `--base_module`.

*   `@@<repo_name>`: The repo with the given [canonical
    name](/external/overview#canonical-repo-name).
...
*   `--verbose` *default: "false"*: Include in the output graph extra
    ...
    Selection](/external/module#version-selection).
...
*   `--output <mode>`: Include information about the module extension usages as
    ...
    *   `graph`: Outputs the graph in the Graphviz *dot* representation.
    ...
    <Tip>
    Use the following command to pipe the output through the *dot* engine
...
The available options are listed in the following section. See also the 
[Command-Line Reference](/reference/command-line-reference#mod) for a 
comprehensive list of options for all bazel commands.
...
<Columns cols={2}>
  <Card title="Graph Before Resolution">
    <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_33oBWv0plYpZ78RGDScbYDj8Ise/mod_exampleBefore-1760391093.svg" alt="Graph Before Resolution" />
  </Card>

  <Card title="Graph After Resolution">
    <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_33oBWv0plYpZ78RGDScbYDj8Ise/mod_exampleResolved-1760391093.svg" alt="Graph After Resolution" />
  </Card>
</Columns>

<div id="mod-example1">
### Example 1: Display the whole dependency graph
...
<Note>
The `...` symbol indicates that the node has already been expanded
somewhere else and was not expanded again to reduce noise.
</Note>
</div>

<div id="mod-example2">
### Example 2: Display graph with unused modules
...
<div id="mod-example3">
### Example 3: Display graph from specific modules
...
<Note>
The dotted line is used to indicate an *indirect* (transitive)
dependency edge between two nodes.
</Note>
</div>

<div id="mod-example4">
### Example 4: Display all paths between modules
...
<div id="mod-example5">
### Example 5: Explain module dependencies
...
<div id="mod-example6">
### Example 6: Show repo definitions
...
<div id="mod-example7">
### Example 7: Show module extensions
...
<div id="mod-example8">
### Example 8: Show extension repos
...
### Example 9: Show extension usage details
...
### Example 10: Show repo from another module's perspective
