...
<Columns cols={2}>
  <Card title="← Targets" href="/concepts/build-ref" icon="arrow-left">
    Learn about build targets
  </Card>
  <Card title="BUILD files →" href="/concepts/build-files" icon="arrow-right">
    Understand BUILD file syntax
  </Card>
</Columns>
